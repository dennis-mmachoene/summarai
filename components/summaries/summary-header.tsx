      ...
      <div className="space-y-6">
        <div className="flex flex-wrap items-center gap-4">
          ...
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            {reading_time ? reading_time : 0} min read
          </div>
        </div>
        <h1 className="bg-linear-to-r from-rose-600 to-orange-600 bg-clip-text text-transparent">
      ...
      <div className="self-start">
        <Link href="/dashboard" className="hover:no-underline">
          <Button
            variant={"link"}
            size="sm"
            className="group flex items-center gap-1 sm:gap-2 hover:bg-white/80 backdrop-blur-xs rounded-full transition-all duration-200 shadow-xs hover:shadow-md border border-rose-100/30 bg-rose-100 px-2 smpx-3"
          >
            <ChevronLeft className="h-3 w-3 sm:h-4 sm:w-4 text-rose-500 transition-transform group-hover:translate-z-0.5" />
